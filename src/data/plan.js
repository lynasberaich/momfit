...
export const walkingPlan = {
  ...
  '2026-05-05': { miles: 3 },
  '2026-05-06': { miles: 2.5 },
  '2026-05-07': { miles: 3, intervals: 'push to 13:00–14:00 /mi pace' },
  '2026-05-08': { miles: 2.5 },
  '2026-05-09': { miles: 3, intervals: 'push to 13:00–14:00 /mi pace' },

  '2026-05-10': { miles: 3.5 },
  '2026-05-11': { rest: true },
  '2026-05-12': { miles: 3 },
  '2026-05-13': { miles: 3.5 },
  '2026-05-14': { miles: 3, intervals: 'push to 13:00–14:00 /mi pace' },
  '2026-05-15': { miles: 2.5 },
  '2026-05-16': { miles: 3, intervals: 'push to 13:00–14:00 /mi pace' },

  '2026-05-17': { miles: 3.5 },
  '2026-05-18': { rest: true },
  '2026-05-19': { miles: 3.5 },
  '2026-05-20': { miles: 3 },
  '2026-05-21': { miles: 3.5, intervals: 'push to 13:00–14:00 /mi pace' },
  '2026-05-22': { miles: 3 },
  '2026-05-23': { miles: 3.5, intervals: 'push to 13:00–14:00 /mi pace' },

  '2026-05-24': { miles: 3.5 },
  '2026-05-25': { rest: true },
  '2026-05-26': { miles: 3.5 },
  '2026-05-27': { miles: 3 },
  '2026-05-28': { miles: 3.5, intervals: 'push to 13:00–14:00 /mi pace' },
  '2026-05-29': { miles: 3 },
  '2026-05-30': { miles: 3.5, intervals: 'push to 13:00–14:00 /mi pace' },
  ...
  '2026-06-02': { miles: 4 },
  '2026-06-03': { miles: 3.5 },
  '2026-06-04': { miles: 4 },
  '2026-06-05': { miles: 3.5 },
  '2026-06-06': { miles: 4 },

  '2026-06-07': { miles: 4 },
  '2026-06-08': { rest: true },
  '2026-06-09': { miles: 4 },
  '2026-06-10': { miles: 3.5 },
  '2026-06-11': { miles: 4 },
  '2026-06-12': { miles: 3.5 },
  '2026-06-13': { miles: 4 },

  '2026-06-14': { miles: 4.25, intervals: '2 min fast / 2 min easy' },
  '2026-06-15': { rest: true },
  '2026-06-16': { miles: 4 },
  '2026-06-17': { miles: 4.25, intervals: '2 min fast / 2 min easy' },
  '2026-06-18': { miles: 4 },
  '2026-06-19': { miles: 3.5, intervals: '2 min fast / 1 min easy' },
  '2026-06-20': { miles: 4 },

  '2026-06-21': { miles: 4.25, intervals: '2 min fast / 2 min easy' },
  '2026-06-22': { rest: true },
  '2026-06-23': { miles: 4 },
  '2026-06-24': { miles: 4.25, intervals: '2 min fast / 2 min easy' },
  '2026-06-25': { miles: 4 },
  '2026-06-26': { miles: 3.5, intervals: '2 min fast / 1 min easy' },
  '2026-06-27': { miles: 4 },

  '2026-06-28': { miles: 4.5, intervals: '2 min fast / 2 min easy' },
